...
#   c) node1 mines 32 blocks, so now node 0 has 500000USD, node 1 has 4250USD, node2 has none.
#   d) node0 sends 601 USD to node2, in two transactions (301 USD, then 300 USD).
