...
In order to support loading of multiple wallets in unitedstatedollarcrypto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is unitedstatedollarcrypto.cpp.
...
Changes to unitedstatedollarcrypto.cpp
----------------------
unitedstatedollarcrypto.cpp is the entry point into unitedstatedollarcrypto-qt, and as such, will require some minor modifications to provide hooks for
