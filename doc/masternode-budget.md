...
USD Coin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<unitedstatedollarcrypto_address\> \<monthly_payment_unitedstatedollarcrypto\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ USD, _12_ times over the course of a year totaling _24000_ USD.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<unitedstatedollarcrypto_address\> \<monthly_payment_unitedstatedollarcrypto\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` USD.
 ...
 * vote-many          - Vote on a USD Coin initiative
 * vote-alias         - Vote on a USD Coin initiative
 * vote               - Vote on a USD Coin initiative/budget
