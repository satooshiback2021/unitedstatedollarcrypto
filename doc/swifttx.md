...
This mechanism has been integrated into Bitcore-Node-Unitedstatedollarcrypto which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unitedstatedollarcrypto/insight-api-unitedstatedollarcrypto#web-socket-api](https://github.com/unitedstatedollarcrypto/insight-api-unitedstatedollarcrypto#web-socket-api)
* API: [https://github.com/unitedstatedollarcrypto/insight-api-unitedstatedollarcrypto#swifttx-transactions](https://github.com/unitedstatedollarcrypto/insight-api-unitedstatedollarcrypto#swifttx-transactions)
...
By default, the USD Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the USD Coin Core daemon:
