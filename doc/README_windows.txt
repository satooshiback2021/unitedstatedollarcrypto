...
Intro
-----
USD Coin (USD) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. USD Coin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run unitedstatedollarcrypto-qt.exe.

USD Coin Core is the original USD Coin client and it builds the backbone of the network.
However, it downloads and stores the entire history of USD Coin transactions;
