...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop USD Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "USD Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* USD Coin features */
        {"unitedstatedollarcrypto", "masternode", &masternode, true, true, false},
        {"unitedstatedollarcrypto", "listmasternodes", &listmasternodes, true, true, false},
        {"unitedstatedollarcrypto", "getmasternodecount", &getmasternodecount, true, true, false},
        {"unitedstatedollarcrypto", "masternodeconnect", &masternodeconnect, true, true, false},
        {"unitedstatedollarcrypto", "masternodecurrent", &masternodecurrent, true, true, false},
        {"unitedstatedollarcrypto", "masternodedebug", &masternodedebug, true, true, false},
        {"unitedstatedollarcrypto", "startmasternode", &startmasternode, true, true, false},
        {"unitedstatedollarcrypto", "createmasternodekey", &createmasternodekey, true, true, false},
        {"unitedstatedollarcrypto", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"unitedstatedollarcrypto", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"unitedstatedollarcrypto", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"unitedstatedollarcrypto", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"unitedstatedollarcrypto", "getmasternodescores", &getmasternodescores, true, true, false},
        {"unitedstatedollarcrypto", "mnbudget", &mnbudget, true, true, false},
        {"unitedstatedollarcrypto", "preparebudget", &preparebudget, true, true, false},
        {"unitedstatedollarcrypto", "submitbudget", &submitbudget, true, true, false},
        {"unitedstatedollarcrypto", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"unitedstatedollarcrypto", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"unitedstatedollarcrypto", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"unitedstatedollarcrypto", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"unitedstatedollarcrypto", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"unitedstatedollarcrypto", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"unitedstatedollarcrypto", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"unitedstatedollarcrypto", "checkbudgets", &checkbudgets, true, true, false},
        {"unitedstatedollarcrypto", "mnsync", &mnsync, true, true, false},
        {"unitedstatedollarcrypto", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> unitedstatedollarcrypto-cli " + methodname + " " + args + "\n";
}
