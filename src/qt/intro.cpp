...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("USD Coin Core"),
     ...
     * override -datadir in the unitedstatedollarcrypto.conf file in the default data directory
     * (to be consistent with unitedstatedollarcryptod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
