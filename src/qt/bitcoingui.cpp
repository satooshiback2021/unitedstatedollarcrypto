                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("USD Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a USD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unitedstatedollarcrypto: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About USD Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about USD Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for USD Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your USD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified USD addresses"));
    ...
    openAction->setStatusTip(tr("Open a unitedstatedollarcrypto: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the USD Coin Core help message to get a list with possible USD Coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("USD Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to USD Coin network", "", count));
}
...
{
    QString strTitle = tr("USD Coin Core"); // default title
