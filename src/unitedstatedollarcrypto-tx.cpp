...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("USD Coin Core unitedstatedollarcrypto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  unitedstatedollarcrypto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded USD Coin transaction") + "\n" +
                               "  unitedstatedollarcrypto-tx [options] -create [commands]   " + _("Create hex-encoded USD Coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded USD Coin transaction
