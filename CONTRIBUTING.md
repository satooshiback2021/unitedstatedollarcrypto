Contributing to USD Coin Core
==================================

The USD Coin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to unitedstatedollarcrypto-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the unitedstatedollarcrypto unit tests or QA tests
...
The following applies to code changes to the USD Coin Core project, and is not to be
confused with overall USD Coin Network Protocol consensus changes.

Whether a pull request is merged into USD Coin Core rests with the project merge
...
Patches that change USD Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the USD Coin consensus, it must have been
...
The project leader is the release manager for each USD Coin Core release.
